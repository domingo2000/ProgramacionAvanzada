...
if __name__ == "__main__":
    try:
        ...
        back_cliente.senal_actualizar_puntos_usuario.connect(
            ventana_juego.actualizar_puntos_usuario)
        ...
        back_cliente.senal_habilitar_ladron.connect(ventana_juego.habilitar_ladron)
        back_cliente.senal_dar_usuarios_intercambio.connect(
            ventana_juego.abrir_ventana_intercambio_1)
        ...
        ventana_juego.senal_ladron_dropeado.connect(back_cliente.enviar_ladron_dropeado)
        ventana_juego.senal_pedir_usuarios_intercambio.connect(
