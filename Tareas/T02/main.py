...
if __name__ == "__main__":
    ...
    ventana_juego.senal_teclas_presionadas.connect(back_juego.revisar_cheat)
    ventana_juego.senal_estado_tienda.connect(back_juego.cambiar_estado_tienda)
    ...
    back_juego.senal_primer_pinguino.connect(ventana_juego.activar_box_canciones)
    back_juego.senal_primer_pinguino.connect(ventana_juego.activar_box_dificultad)
